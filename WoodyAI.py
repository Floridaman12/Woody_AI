        ...
        if mode == "death":
            while questionNumber <= 10:    
                ...
                if question[0:len(question)] == "rick roll":
                    thinking()
                    os.system("cls")  #clsing shell
                    print(colorama.Fore.BLUE+"Hi!I am Woody AI! You can ask me questions like my mood, the time, name, learn, and help. Some other commands include moo, computer, save me, and kill. "  + colorama.Fore.WHITE)  #printing answer
                    #giving time becolorama.Fore next question
                    questionNumber += 1
                if question[0:len(question)] == "name":  #seeing what the user inputted
                    thinking()
